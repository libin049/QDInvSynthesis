...
(>= i 100000);
 (>= x 100000);
 (= _ret 0);
 exist _i0 in [0,1,100000),(= (select a _i0) 50);
 forall _i0 in [0,1,(- i 1)),(= (select a _i0) 50);
 forall _i0 in [0,1,i),(= (select a _i0) 50);
 forall _i0 in [0,1,100000),(= (select a _i0) 50);
 forall _i0 in [0,1,(- x 1)),(= (select a _i0) 50);
...
(>= i 100000);
 ...
 forall _i0 in [0,1,i),(= (select a _i0) 50);
 forall _i0 in [0,1,100000),(= (select a _i0) 50);
 {forall _i0 in [0,1,(- x 1)),(= (select a _i0) 50)} || {(= x 0)};
 forall _i0 in [0,1,x],(= (select a _i0) 50);
...
(< i 100000);
 forall _i0 in [0,1,i),(= (select a _i0) 50);
 {exist _i0 in [0,1,100000),(= (select a _i0) 50)} || {(= i 0)};
 {exist _i0 in [0,1,100000),(= (select a _i0) 50)} || {exist _i0 in [0,1,100000),(= (select a _i0) 49)};
 {exist _i0 in [0,1,100000),(= (select a _i0) 50)} || {forall _i0 in [0,1,100000),(= (select a _i0) 49)};
 {forall _i0 in [0,1,(- i 1)),(= (select a _i0) 50)} || {(= i 0)};
 {forall _i0 in [0,1,(- i 1)),(= (select a _i0) 50)} || {exist _i0 in [0,1,100000),(= (select a _i0) 49)};
 {forall _i0 in [0,1,(- i 1)),(= (select a _i0) 50)} || {forall _i0 in [0,1,100000),(= (select a _i0) 49)};
