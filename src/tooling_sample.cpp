...
//		std::cout<<"*******************process function::  "<<FuncName <<"***************"<<"\n";	
		...
		EnvironmentAnalysis* env=new EnvironmentAnalysis(f,cfg,emu,c,z3coding,ava,newc2z3,multiIndexesRelationAnalysis);
		...
		//if(liftAnalysis->forAllFormulaCount>0){
			...
			hasOrFormulaLoopCount+=liftAnalysis->hasOrFormulaLoopCount;
		...
		//}
//		printf("%f ", timeuse/1000000) ;
//		printf("%d  ", liftAnalysis->blockCount) ;
//		printf("%d  ", liftAnalysis->forAllFormulaCount) ;
//		printf("%d  ", liftAnalysis->existFormulaCount) ;
//		printf("%d  ", liftAnalysis->simpleFormulaCount) ;
//		printf("%d  ", liftAnalysis->loopCount) ;
//		printf("%d  ", liftAnalysis->hasForallFormulaLoopCount) ;
//		printf("%d  ", liftAnalysis->hasExistFormulaLoopCount) ;
//		printf("%d  \n", liftAnalysis->hasForallOrExistFormulaLoopCount) ;
...
int main(int argc, const char **argv) {
	...
	printf("%d  ", hasOrFormulaLoopCount) ;
