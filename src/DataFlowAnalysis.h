#ifndef _DATAFLOWANALYSIS_H
#define _DATAFLOWANALYSIS_H
#include <map>
#include <list>
#include <string>
#include <sstream>
...
public: 
	IntraDataFlowAnalysis(FunctionDecl * functionDecl, clang::CFG* cfg){
		this->functionDecl=functionDecl;
		this->cfg=cfg;
		generateParmVarDecl();
	}	
	virtual ~IntraDataFlowAnalysis(){}
